#
# Be sure to run `pod spec lint Goodreads-Oauth.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  #
  s.source       = { :git => "https://github.com/yjkogan/goodreads-oauth", :tag => "1.0.0" }
  ...
  #
  s.source_files = 'Dependencies', '*.{h,m}'
